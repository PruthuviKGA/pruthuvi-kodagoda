...
export const EXPERIENCES2 = {
  ...
  description: `Full-stack developer with hands-on experience contributing to multiple projects focused on carbon credit management systems supporting global climate finance initiatives. Skilled in building scalable web applications and system integrations, including independently developing a Leave Management System using the SPFx framework to streamline HR operations. Experienced in designing and maintaining RESTful APIs for seamless frontend-backend communication and collaborating effectively with cross-functional teams while upholding strict confidentiality standards.`,
  technologies: [
    "ReactTS",
    "SCSS",
    "NestJS",
